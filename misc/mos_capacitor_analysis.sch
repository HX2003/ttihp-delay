...
Since we know the current, then C = I / (dV/dt)

To read the capacitance value at a particular gate voltage,
read the 'cap' value of the graph, corresponding to the timestamp when the 'gate' is at your desired voltage.} -1170 -600 0 0 0.4 0.4 {}
N -380 -300 -200 -300 {lab=gate}
N -380 -240 -170 -240 {lab=GND}
N -170 -330 -170 -240 {lab=GND}
...
C {lab_pin.sym} -310 -300 2 0 {name=p10 lab=gate}
C {sg13g2_pr/sg13_lv_nmos.sym} -190 -300 0 0 {name=M1
l=7u
w=56u
ng=8
m=2
